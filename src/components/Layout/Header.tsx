      ...
      <nav className="px-4 sm:px-6 py-2 flex items-center justify-between">
        ...
        {auth && auth.user ? (
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 rounded-lg bg-blue-600 border border-blue-400 text-white hover:bg-blue-700 transition group relative active:outline outline-blue-500 outline-offset-2 z-50"
          >
            <svg
